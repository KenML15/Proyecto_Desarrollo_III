...
//    
//    // REGLA DE NEGOCIO #1: Vehículo ya parqueado
//    if (urlParams.get('error') === 'already_parked') {
//        alert("⚠️ ATENCIÓN:\n\nEste vehículo ya tiene un ingreso activo en el sistema.\nDebe registrar la salida antes de ingresarlo de nuevo.");
//    }
//    
//    // Si quieres algo más visual que un alert, puedes usar un innerHTML
...
/**
 * Assignment.js
 * Versión corregida: Unificada y con validación de límite de espacios.
 */
