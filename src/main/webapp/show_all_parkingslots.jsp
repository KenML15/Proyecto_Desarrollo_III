...
<html>
    ...
    <body>
        <div id="titulo"><h2>Gestión de Locales de Parqueo</h2></div>
        ...
        <div class="container container--wide">
            <table border="1" id="parkingTable">
                <thead>
                    <tr id="encabezado">
                        <th>ID</th><th>Nombre del Local</th><th>Capacidad (Espacios)</th><th>Acciones</th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach var="p" items="${listaParqueos}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="assignments?action=board&id=${p.id}&name=${p.name}" class="save btn-table" style="background-color:#16a085;">
                                    Ver Tablero
                                </a>
                            </td>
                        </tr>
