...
/**
 * Servlet that handles CRUD operations for system users.
 * Only accessible by admins (enforced by RoleFilter).
 *
 * @author Generated
 */
@WebServlet("/users")
public class UserController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("update".equalsIgnoreCase(action)) {
            ...
            // Duplicate username check (excluding itself)
            ...
            User user = new User(id, username, password, role, active);
            userDAO.update(user);
            ...
            User user = new User(0, username, password, role, active);
