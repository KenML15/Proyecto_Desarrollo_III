...
public class TicketDAO {
    ...
    public Ticket findById(int id) {
        ...
        try (Connection conn = DbConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                if (rs.getTimestamp("exit_date") != null)
                    t.setExitDate(rs.getTimestamp("exit_date").toLocalDateTime());
    ...
    /**
     * Counts open (active) tickets that belong to a given parking lot.
     * Joins ticket → vehicle_assignment to find the lot.
     */
    ...
    // ─────────────────────────────────────────────
    // HELPER: map ResultSet row to Ticket object
    // ─────────────────────────────────────────────
